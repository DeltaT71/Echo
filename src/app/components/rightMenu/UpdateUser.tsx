      ...
      {isOpen && (
        <div className="absolute w-screen h-screen top-0 left-0 bg-black/75 flex items-center justify-center z-50">
          <form
            action={
              ...
              async (formData) => {
                ...
                //Refresh the page so the user can see the changes
          ...
          >
            ...
            <button className="bg-teal-700 py-1 px-4 rounded-lg hover:bg-teal-300 hover:text-black transition-all w-full mx-auto">
              Update
            </button>
