    ...
    <div>
      ...
      {isOpen && (
        <div className="absolute w-screen h-screen top-0 left-0 bg-black/75 flex items-center justify-center z-50">
          <div className="w-full xs:w-1/4 md:w-1/2 xl:w-1/3 max-h-screen overflow-y-auto p-6">
            <form
              action={
              ...
              className="p-12 bg-neutral-800 rounded-lg shadow-lg flex flex-col ring-1 ring-teal-500 gap-2 relative"
            >
              {/* TITLE */}
