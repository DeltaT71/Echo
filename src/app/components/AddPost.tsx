  ...
  return (
    <>
      {user ? (
        ...
        <div className="p-4 bg-neutral-800 shadow-xl rounded-lg flex gap-4 justify-between text-sm flex-wrap text-yellow-500">
          Please Login or Create an Account to make a Post!
        </div>
      )}
    </>
  );
